...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_float, 1, 'tcp://127.0.0.1:50002', 100, False, -1)
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, default_samp_rate,True)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_char*1, int((default_samp_rate/baud_rate)*1.05))
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\Avipe\\Desktop\\Year 4\\Final Project - Nano-Satelllite Transmitter\\GNU Radio Tests\\0.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.analog_sig_source_x_0 = analog.sig_source_f(default_samp_rate, analog.GR_COS_WAVE, carrier, 1, 0, 0)
    ...
    def get_default_samp_rate(self):
        return self.default_samp_rate

    def set_default_samp_rate(self, default_samp_rate):
        self.default_samp_rate = default_samp_rate
        self.analog_sig_source_x_0.set_sampling_freq(self.default_samp_rate)
        self.blocks_repeat_0.set_interpolation(int((self.default_samp_rate/self.baud_rate)*1.05))
        self.blocks_throttle_0.set_sample_rate(self.default_samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.default_samp_rate)
