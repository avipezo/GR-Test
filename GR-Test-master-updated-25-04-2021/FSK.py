...
class FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FSK Modulator")
        ...
        # Variables
        ##################################################
        self.carrier = carrier = 145.97e6
        self.Fs = Fs = 16*carrier
        self.Ts = Ts = 1/Fs
        self.Rb = Rb = 9600
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.pfb_decimator_ccf_0, 0))
